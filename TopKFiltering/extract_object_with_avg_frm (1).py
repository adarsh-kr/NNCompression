...
parser.add_argument('--area', '--area_limit', default=2000, type=int, help = 'min area of the bounding box')
parser.add_argument('--frm_path', default="../datasets/Lausanne/frames/", type = str, help="from path")
parser.add_argument('--out_path', default="../results/TopKFiltering/Lausanne/objectImgs/", type = str, help="output folder")
...
if __name__ == "__main__":
    ...
    for line in open(os.path.join(frm_path, '..', 'frm_map.txt')):
        ...
        th1 = median
        cv2.imwrite(os.path.join(output_path, 'tmp2.jpg'), th1)
